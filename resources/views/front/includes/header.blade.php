                    ...
                    <ul class="collapse formulario list-unstyled dropdown-menu" id="sub-item-12">
                        <li class="">
                          ...
                          <div class="cont-preguntar">
                            {{-- <a class="text-login" href="#" style="padding-right: 39px;">Olvidé mi Clave</a>
                            <a class="text-login" href="#">Olvidé mi Email</a> --}}
            ...
            <div class="contenido-menu">
              ...
              <ul class="nav navbar-nav navbar-login">
                ...
                <li class="link-logout">
                  <a class="btn-salir form-horizontal-responsive" title="Cerrar Sesión" href="{{ url('/salir') }}"onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                    <span class="menu-login" id="titulo">
