...
<!--[if !IE]><!-->
  ...
  <link href="<?php echo URL::asset('css/style.css?v=1.3'); ?>" rel="stylesheet" type="text/css" />
...
<!-- End Google Tag Manager -->
  ...
  <script type="text/javascript" src="//script.crazyegg.com/pages/scripts/0081/0399.js" async="async"></script>
    <script>
    var url = "{!! url('/') !!}";
    var public_key_capcha = "<?php echo env('NOCAPTCHA_SITEKEY')?>";
  </script>
...
<!-- End Google Tag Manager (noscript) -->
      ...
      @include('front.includes.header')
                                ...
                                <form class="form-horizontal" role="form" method="POST" action="{{ route('subscription') }}">
                                  ...
                                  <div class="input-group-btn">
                                    <div class="input-group">
                                      <input class="form-control home-input-search filtro-central" placeholder="{!!trans('contenido.boletin_mail')!!}" pattern="[^@\s]+@[^@\s]+\.[^@\s]+"  name="email" required>
                                      <span class="input-group-btn fondo-rojo">
                                        <button class="btn btn-secondary fondo-rojo border-cero"><span class="text-blanco">{!!trans('contenido.boletin_subs')!!}</span></button>
                                      </span>
                                    </div>
                                  </div>
                                </form>
                              </div>
                              <img src="{!!url('/images/close.png')!!}" alt="Botón Close" class="icon-boletin">
                            </div>
                            @else
                              <div class="col-md-10 col-nopadding boletin-container">
                                <p class="aviso-boletin">{!!trans('contenido.boletin_gracias')!!}</p>
                              </div>
                              <div class="col-md-5 col-nopadding col-boletin">
                                <img src="{!!url('/images/close.png')!!}" alt="Botón Close" class="icon-boletin">
                              </div>
                            @endif
        ...
        @if(!\Session::has('notificationalert'))
        ...
        @endif
          ...
          @endif --}}
            ...
            <img class="fab__image" src="{!!url('/images/push-off.png')!!}" alt="Push Notification"/>
          </div>
    ...
    <div class="g-recaptcha" data-sitekey="<?php echo env('NOCAPTCHA_SITEKEY')?>"></div>
     @yield('script')
     <script type="text/javascript">
