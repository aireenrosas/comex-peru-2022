  ...
  <div class="col-md-12 cont-tabla">
      <div class="portlet light ">
          ...
          <div class="row col-md-12">
            <div class="portlet-title tabbable-line">
              <div class="caption caption-md">
                  <h2 class="">Agregar presentaciones</h2>
              </div>
            </div>
            {!! Form::open(['url' => '/admin/seminars/savedocumentos', 'method' => 'POST', 'files' => 'true'])!!}
            <input type="hidden" name="seminar_id" value="{{$seminario}}"/>
            <div class="portlet-body">
              <div class="col-md-12">
                <div class="col-md-12 form-group">
                  <label class="label-input-format label-titulo">Título</label>
                  {!! Form::text('doc_titulo',null ,['class' => 'input-admin form-control', 'placeholder' => 'Escribe el título del documento', 'required'])!!}
                </div>
                <div class="col-md-12 form-group">
                  <label class="label-input-format label-titulo">Tema</label>
                  {!! Form::textarea('doc_tema',null ,['class' => 'input-admin form-control', 'placeholder' => 'Escribe el tema del documento', 'rows'=>'2', 'required'])!!}
                </div>
                <div class="col-md-12 form-group">
                  <label class="label-input-format label-titulo">Observación</label>
                  {!! Form::textarea('doc_observacion',null ,['class' => 'input-admin form-control', 'placeholder' => 'Escribe la observación del documento', 'rows'=>'5'])!!}
                </div>
