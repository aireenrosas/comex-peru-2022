      ...
      <div class="portlet light ">
          <div class="portlet-title tabbable-line">
            <div class="caption caption-md">
                <h1 class="titulo-editar">Editar Slider</h1>
            </div>
          </div>
          {!! Form::open(['url' => '/admin/sliders/'.$slider->id, 'method' => 'PATCH', 'files'=>'true', 'id' => 'formSlider'])!!}
          <div class="portlet-body">
              ...
              <div class="col-md-6">
                <div class="col-md-12 form-group">
                  ...
                  <img src="{{url('/upload/sliders/'. $slider->image)}}" class="imagen-slider" />
                  <input type="file" class="file" name="file_slider">
                  <div class="col-md-12">
                ...
                <div class="section-spanish">
                  <div class="col-md-12 form-group">
                    ...
                    @if(isset($slider_es))
                      {!! Form::text('title_es',$slider_es->title ,['class' => 'input-admin form-control', 'placeholder' => 'Escribe el nombre del slider'])!!}
                    @else
                  ...
                  <div class="col-md-12 form-group">
                    ...
                    @if(isset($slider_es))
                      {!! Form::textarea('text_es',$slider_es->text ,['class' => 'form-control input-admin wysi-textarea', 'placeholder' => 'Escriba el texto del slider'])!!}
                    @else
                  ...
                  <div class="col-md-12 form-group">
                    ...
                    @if(isset($slider_es))
                      {!! Form::text('button_text_es',$slider_es->button_text ,['class' => 'input-admin form-control', 'placeholder' => 'Escribe el texto del botón', 'id' => 'btnText'])!!}
                    @else
                      {!! Form::text('button_text_es',null ,['class' => 'input-admin form-control', 'placeholder' => 'Escribe el texto del botón', 'id' => 'btnText'])!!}
                    @endif
                  </div>
                  <div class="col-md-12 form-group">
                    <label class="label-input-format label-titulo">Url</label>
                    @if(isset($slider_es))
                      {!! Form::text('url_es',$slider_es->url ,['class' => 'input-admin form-control', 'placeholder' => 'Escribe la Url', 'id' => 'btnUrl'])!!}
                    @else
                ...
                <div class="section-english hidden">
                  <div class="col-md-12 form-group">
                    <label class="label-input-format label-titulo">Título</label>
                    @if(isset($slider_en))
                      {!! Form::text('title_en',$slider_en->title ,['class' => 'input-admin form-control', 'placeholder' => 'Escribe el nombre del slider'])!!}
                    @else
                  ...
                  <div class="col-md-12 form-group">
                    <label class="label-input-format label-titulo">Texto</label>
                    @if(isset($slider_en))
                      {!! Form::textarea('text_en',$slider_en->text ,['class' => 'form-control input-admin wysi-textarea', 'placeholder' => 'Escriba el texto del slider'])!!}
                    @else
                  ...
                  <div class="col-md-12 form-group">
                    <label class="label-input-format label-titulo">Texto Botón</label>
                    @if(isset($slider_en))
                      {!! Form::text('button_text_en',$slider_en->button_text ,['class' => 'input-admin form-control', 'placeholder' => 'Escribe el texto del botón', 'id' => 'btnTextE'])!!}
                    @else
                  ...
                  <div class="col-md-12 form-group">
                    <label class="label-input-format label-titulo">Url</label>
                    @if(isset($slider_en))
                      {!! Form::text('url_en',$slider_en->url ,['class' => 'input-admin form-control', 'placeholder' => 'Escribe la Url', 'id' => 'btnUrlE'])!!}
                    @else
