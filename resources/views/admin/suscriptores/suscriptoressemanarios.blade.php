      ...
      <div class="portlet light ">
          <div class="portlet-title tabbable-line">
            <div class="caption caption-md">
              <h1 class="titulo-contenido">Semanarios</h1>
            </div>
          </div>
          {!! Form::open(['url' => '/admin/semanariosubcripciones', 'method' => 'GET']) !!}
          ...
          <div class="col-lg-6 col-xs-12 col-md-8 col-sm-12" style="text-align: center">
            <div class="col-xs-8">
              {!! Form::text('filtro_sussemanario', $request->input('filtro_sussemanario'),['class' => 'form-control filtro_sussemanario','placeholder'=> 'Nombre...','id'=>'filtro_sussemanario'])!!}
            </div>
            <button id="search_semanario" class="btn btn-nuevo" type="submit">Buscar</button>
          ...
          <div class="portlet-body">
              <div class="table-scrollable">
                <div class="pagination-box" align="center" style="width: 100%">
                  {{$suscriptores->appends(['filtro_sussemanario'=>$request->input('filtro_sussemanario')])->links()}}
                </div>
                  <table class="table table-hover table-bordered" id="semanarios">
                    <thead>
                        <tr>
...
$('.filtro_sussemanario').val('');
$('#search_semanario').click();
}
</script>
@endsection
