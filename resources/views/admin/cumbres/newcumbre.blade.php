      ...
      <div class="portlet light ">
          <div class="portlet-title tabbable-line">
            <div class="caption caption-md">
                <h1 class="titulo-editar">Nueva Cumbre</h1>
            </div>
          </div>
          {!! Form::open(['url' => '/admin/cumbres', 'method' => 'POST','id' =>'cumbre'])!!}
              ...
              <div class="col-md-6">
                ...
                <div class="section-spanish ">
                  ...
                  <div class="col-md-12 form-group">
                    ...
                    {!! Form::text('name_es',null ,['class' => 'form-control input-admin', 'placeholder' => 'Escribe el nombre de la cumbre'])!!}
                  </div>
                  <div class="col-md-12 form-group">
                    <label class="label-input-format label-titulo">Descripción</label>
                    {!! Form::textarea('description_es',null ,['class' => 'form-control input-admin wysi-textarea', 'placeholder' => 'Escriba el contenido de la cumbre'])!!}
                  </div>
                  <div class="col-md-12 form-group">
                    <label class="label-input-format label-titulo">Título</label>
                    {!! Form::text('title_es',null ,['class' => 'form-control input-admin', 'placeholder' => 'Escribe el título'])!!}
                  </div>
                  <div class="col-md-12 form-group">
                ...
                <div class="section-english hidden">
                  ...
                  <div class="col-md-12 form-group">
                    <label class="label-input-format label-titulo">Nombre</label>
                    {!! Form::text('name_en',null ,['class' => 'form-control input-admin', 'placeholder' => 'Escribe el nombre de la cumbre'])!!}
                  </div>
                  <div class="col-md-12 form-group">
                    <label class="label-input-format label-titulo">Descripción</label>
                    {!! Form::textarea('description_en',null ,['class' => 'form-control input-admin wysi-textarea', 'placeholder' => 'Escriba el contenido de la cumbre'])!!}
                  </div>
                  <div class="col-md-12 form-group">
                    <label class="label-input-format label-titulo">Título</label>
                    {!! Form::text('title_en',null ,['class' => 'form-control input-admin', 'placeholder' => 'Escribe el título'])!!}
                  </div>
                  <div class="col-md-12 form-group">
                    <label class="label-input-format label-titulo">Lugar</label>
                    {!! Form::text('place_en',null ,['class' => 'form-control input-admin', 'placeholder' => 'Escribe el lugar de la cumbre'])!!}
                  </div>
                </div>

                <div class="col-md-12 form-group">
                  <label class="label-input-format label-titulo" style="width: 100%;">Fecha</label>
                  <input class="form-calendar" type="date"  name="fecha" /><i class="fa fa-calendar ico-calendar" aria-hidden="true"></i>
                </div>
                <div class="col-md-12 form-group">
                  <label class="label-input-format label-titulo">Hora</label>
                  {!! Form::time('time',null ,['class' => 'form-control input-admin', 'placeholder' => 'Escribe la hora de la cumbre'])!!}
                </div>
                <div class="col-md-12 form-group">
                  <label class="label-input-format label-titulo">Url</label>
                  {!! Form::text('url',null ,['class' => 'form-control input-admin', 'placeholder' => 'https://www...'])!!}
                </div>
              </div>
